...
include(ROOT_PATH.'extend/aliyun-dysms-php-sdk/api_sdk/vendor/autoload.php');
...
class Alidayu
{
	private static $id = 'LTAIOFJU05NVVJ1s';
	private static $secret = 'JRGFwWdqSetvBDvglzcQnpCvDjYy4p';
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = self::$id; // AccessKeyId

        $accessKeySecret = self::$secret; // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($phone, $sms_code, $cont, $sign) {
        ...
        $request->setTemplateParam(json_encode($cont, JSON_UNESCAPED_UNICODE));
